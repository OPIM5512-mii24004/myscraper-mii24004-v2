...
def run_once(dry_run: bool = False, max_depth: int = 12, min_samples_leaf: int = 10):
    ...
    required = {"scraped_at", "price", "make", "model", "year", "mileage", "title_status", "color"}
    ...
    target = "price_num"
    cat_cols = ["make", "model", "title_status", "color"]
    ...
    if not holdout_df.empty:
        ...
        cols = ["post_id", "scraped_at", "make", "model", "year", "mileage", "price", "title_status", "color"]
